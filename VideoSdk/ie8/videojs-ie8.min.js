!(function (a, b) {
  "undefined" == typeof a.HTMLVideoElement &&
    ...
    (function (a, b) {
      ...
      var I =
          ...
          (function () {
            try {
              var a = {};
              e.defineProperty(a, "x", { enumerable: !1, value: a });
          ...
          d,
          {
            filter: function (a) {
              ...
              for (var i = 0; g > i; i++)
                i in f &&
                  ((c = f[i]),
                  ("undefined" == typeof d ? a(c, i, e) : a.call(d, c, i, e)) &&
                    V(h, c));
              return h;
            },
          },
      ...
      d.reduceRight &&
        (ca =
          "object" ==
          typeof d.reduceRight.call("es5", function (a, b, c, d) {
            return d;
          })),
        J(
          d,
      ...
      J(
        d,
        {
          indexOf: function (a) {
            ...
            var d = 0;
            for (
              arguments.length > 1 && (d = M.ToInteger(arguments[1])),
                d = d >= 0 ? d : s(0, c + d);
              c > d;
              d++
            )
      ...
      J(
        d,
        {
          lastIndexOf: function (a) {
            ...
            var d = c - 1;
            for (
              arguments.length > 1 && (d = t(d, M.ToInteger(arguments[1]))),
      ...
      J(
        d,
        {
          splice: function (a, b) {
            ...
            var c = arguments;
            return (
              (this.length = s(M.ToInteger(this.length), 0)),
              arguments.length > 0 &&
                "number" != typeof b &&
                ((c = Q(arguments)),
                c.length < 2 ? V(c, this.length - a) : (c[1] = M.ToInteger(b))),
              m.apply(this, c)
            );
          },
        },
          ...
          splice: function (a, b) {
            for (
              var c,
                d = M.ToObject(this),
                e = [],
                f = M.ToUint32(d.length),
                g = M.ToInteger(a),
                i = 0 > g ? s(f + g, 0) : t(g, f),
                j = t(s(M.ToInteger(b), 0), f - i),
                k = 0;
              j > k;
      ...
      var na = function (a) {
          for (
            var b = M.ToObject(this), c = M.ToUint32(b.length), d = 0;
            d < arguments.length;
        ...
        oa = (function () {
          ...
          return (
            1 !== b || 1 !== a.length || "undefined" != typeof a[0] || !O(a, 0)
          );
        })();
      J(
        d,
      ...
      var ta = !{ toString: null }.propertyIsEnumerable("toString"),
      ...
      var Ia,
        ...
        Oa = La.getTimezoneOffset();
      -720 > Oa
        ? ((Ia = "Tue Jan 02 -45875" !== La.toDateString()),
          (Ja = !/^Thu Dec 10 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(
            Ma.toString()
          )))
        : ((Ia = "Mon Jan 01 -45875" !== La.toDateString()),
          (Ja = !/^Wed Dec 09 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(
            Ma.toString()
          )));
      ...
      var bb = -621987552e5,
        ...
        db =
          ...
          -1 === new Date(bb).toISOString().indexOf(cb),
        eb =
          Date.prototype.toISOString &&
      ...
      J(
        Date.prototype,
        {
          toISOString: function () {
            ...
            a =
              (0 > a ? "-" : a > 9999 ? "+" : "") +
              S("00000" + Math.abs(a), a >= 0 && 9999 >= a ? -4 : -6);
      ...
      var fb = (function () {
        try {
          return (
            ...
            -1 !== new Date(bb).toJSON().indexOf(cb) &&
      ...
      if (ib || hb || !gb) {
        ...
        Date = (function (a) {
          var b = function (c, d, e, f, g, i, j) {
              ...
              return K(k) || J(k, { constructor: b }, !0), k;
            },
            c = new RegExp(
            ...
            e = function (a, b) {
              ...
              return (
                d[b] +
                Math.floor((a - 1969 + c) / 4) -
                Math.floor((a - 1901 + c) / 100) +
                Math.floor((a - 1601 + c) / 400) +
                365 * (a - 1970)
              );
            },
            f = function (b) {
          ...
          J(b, { now: a.now, UTC: a.UTC }, !0),
            (b.prototype = a.prototype),
            J(b.prototype, { constructor: b }, !0);
          var i = function (b) {
            var d = c.exec(b);
            if (d) {
              var g,
      ...
      var lb =
        ...
        mb = {
          ...
          multiply: function (a, b) {
            for (var c = -1, d = b; ++c < mb.size; )
              (d += a * mb.data[c]),
                (mb.data[c] = d % mb.base),
                (d = Math.floor(d / mb.base));
          },
          divide: function (a) {
            for (var b = mb.size, c = 0; --b >= 0; )
              (c += mb.data[b]),
                (mb.data[b] = Math.floor(c / a)),
                (c = (c % a) * mb.base);
          },
        ...
        nb = function (a) {
          var b, c, d, e, f, g, i, k;
          if (((b = j(a)), (b = L(b) ? 0 : Math.floor(b)), 0 > b || b > 20))
            throw new RangeError(
          ...
          if (((d = ""), 0 > c && ((d = "-"), (c = -c)), (e = "0"), c > 1e-21))
            if (
              ((f = mb.log(c * mb.pow(2, 69, 1)) - 69),
              (g = 0 > f ? c * mb.pow(2, -f, 1) : c / mb.pow(2, f, 1)),
              (g *= 4503599627370496),
              (f = 52 - f),
              f > 0)
            ) {
              ...
              mb.multiply(0, g),
                mb.multiply(1 << -f, 0),
                (e = mb.numToString() + S("0.00000000000000000000", 2, 2 + b));
          return (
            b > 0
              ? ((k = e.length),
                (e =
                  b >= k
                    ? d + S("0.0000000000000000000", 0, b - k + 2) + e
                    : d + S(e, 0, k - b) + "." + S(e, k - b)))
              : (e = d + e),
            e
          );
              ...
              i.split = function (c, d) {
                ...
                return (
                  l === e.length
                    ? (i || !m.test("")) && V(j, "")
                    : V(j, S(e, l)),
                  j.length > o ? S(j, 0, o) : j
                );
              };
            })()
          : "0".split(void 0, 0).length &&
            (i.split = function (a, b) {
        ...
        (i.replace = function (a, c) {
          ...
          if (d && e) {
            var f = function (b) {
              ...
              return (
                (a.lastIndex = e),
                V(f, arguments[d - 2], arguments[d - 1]),
                c.apply(this, f)
              );
            };
        ...
        i,
        {
          lastIndexOf: function (a) {
            ...
            for (
              var b = h(this),
                c = h(a),
                d = arguments.length > 1 ? j(arguments[1]) : NaN,
                e = L(d) ? 1 / 0 : M.ToInteger(d),
                f = t(s(e, 0), b.length),
                g = c.length,
                i = f + g;
              i > 0;
      ...
      if (
        ...
        (8 !== parseInt(ub + "08") || 22 !== parseInt(ub + "0x16")) &&
          (parseInt = (function (a) {
            var b = /^[\-+]?0[xX]/;
            return function (c, d) {
              var e = Ab(c),
      ...
      if (I) {
        ...
        Eb(Error.prototype, "message"),
          "" !== Error.prototype.message && (Error.prototype.message = ""),
          Eb(Error.prototype, "name");
      }
    ...
    (function (a, b) {
      ...
      k &&
        ...
        Object.getPrototypeOf ||
          (Object.getPrototypeOf = function (a) {
            ...
            return b || null === b
              ? b
              : "[object Function]" === j(a.constructor)
      ...
      if (!Object.getOwnPropertyDescriptor || o) {
        ...
        Object.getOwnPropertyDescriptor = function (a, b) {
          ...
          var f;
          if (!h(a, b)) return f;
          if (((f = { enumerable: i(a, b), configurable: !0 }), k)) {
            var j = a.__proto__,
              l = a !== g;
            l && (a.__proto__ = g);
            var m = d(a, b),
