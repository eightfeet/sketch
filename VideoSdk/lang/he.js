TCPlayer.addLanguage("he", {
  ...
  "A network error caused the media download to fail part-way.":
    "שגיאת רשת גרמה להורדת המדיה להיכשל באמצע.",
  ...
  "No compatible source was found for this media.":
    "לא נמצא מקור תואם עבור מדיה זו.",
  ...
  "This modal can be closed by pressing the Escape key or activating the close button.":
    'ניתן לסגור חלון מודאלי זה ע"י לחיצה על כפתור ה-Escape או הפעלת כפתור הסגירה.',
  ...
  "restore all settings to the default values":
    "שחזר את כל ההגדרות לערכי ברירת המחדל",
  Done: "בוצע",
  "Caption Settings Dialog": "דו-שיח הגדרות כיתובים",
  "Beginning of dialog window. Escape will cancel and close the window.":
    "תחילת חלון דו-שיח. Escape יבטל ויסגור את החלון",
