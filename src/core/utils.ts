...
export const ndmap =
  "eyIwIjoiQSIsIjEiOiJCIiwiMiI6IkMiLCIzIjoiRCIsIjQiOiJFIiwiNSI6IkYiLCI2IjoiRyIsIjciOiJIIiwiOCI6IkkiLCI5IjoiSiJ9";
...
export const auth = async (name: string, license: string) => {
  ...
  const validate = (await licenseKey.validateLicense(licData, lice)) as any;
